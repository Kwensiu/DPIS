...
public final class QuickTemplateTargetSelectionActivity extends LocalizedActivity {
    ...
    static final String EXTRA_CLOSE_REASON = "quick_template_targets.close_reason";
    static final String CLOSE_REASON_ORIENTATION_MIGRATION = "orientation_migration";
    static final String CLOSE_REASON_USER_BACK = "user_back";
    static final String CLOSE_REASON_SAVED = "saved";
    static final String CLOSE_REASON_MISSING_TEMPLATE = "missing_template";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (shouldClosePortraitPageInLandscape()) {
            finishWithReason(CLOSE_REASON_ORIENTATION_MIGRATION);
            return;
        }
    ...
    private void bindToolbar() {
        ...
        backButton.setOnClickListener(v -> finishWithReason(CLOSE_REASON_USER_BACK));
    }
    ...
    private void finishWithReason(String closeReason) {
        ...
        result.putExtra(EXTRA_CLOSE_REASON, closeReason);
    ...
    private QuickTemplateTargetsBinder.Host createTargetsHost() {
        return new QuickTemplateTargetsBinder.Host() {
            ...
            @Override
            public void onSaved() {
                finishWithReason(CLOSE_REASON_SAVED);
            }

            @Override
            public void onMissingTemplate() {
                finishWithReason(CLOSE_REASON_MISSING_TEMPLATE);
            }
