...
final class DialogWindowSizer {
    private DialogWindowSizer() {
    }

    static void applyCompactWidth(AlertDialog dialog, Context context) {
        applyWidth(dialog, context, Preset.COMPACT);
    }

    static void applyStandardWidth(AlertDialog dialog, Context context) {
        applyWidth(dialog, context, Preset.STANDARD);
    }

    static void applyLargeWidth(AlertDialog dialog, Context context) {
    ...
    static int calculateWindowWidth(int screenWidth,
