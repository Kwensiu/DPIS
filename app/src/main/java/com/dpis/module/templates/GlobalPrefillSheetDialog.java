...
public final class GlobalPrefillSheetDialog {

    public static void show(Activity activity) {
        show(activity, null);
    }

    public static void show(Activity activity, Runnable onUpdated) {
    ...
    public GlobalPrefillSheetDialog(
            Activity activity,
            Runnable onUpdated,
            Runnable onDismissed,
    ...
    public GlobalPrefillEditorBinder.Draft snapshotDraft() {
