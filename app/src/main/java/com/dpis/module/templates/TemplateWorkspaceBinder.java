...
public final class TemplateWorkspaceBinder {
    public interface GlobalPrefillActions {
        public void edit();
    }

    public interface QuickTemplateActions {
    ...
    public TemplateWorkspaceBinder(Context context,
        ...
        this.formatter = new TemplateConfigSummaryFormatter(
                ...
                new TemplateTypefaceResolver(this::resolveImportedTypeface));
    ...
    public void bind(View workspaceView, String query) {
    ...
    private TemplateConfigSummaryFormatter.TypefaceStatus resolveImportedTypeface(String typefaceId) {
        FontLibraryStore fontLibraryStore = ConfigStoreFactory.createLocalUiFontLibraryStore(
