...
public final class QuickTemplateEditSheetDialog {

    public static void show(Activity activity, String templateId) {
        show(activity, templateId, null);
    }

    public static void show(Activity activity, String templateId, Runnable onUpdated) {
    ...
    public QuickTemplateEditSheetDialog(
            Activity activity,
            String templateId,
            Runnable onUpdated,
            Runnable onDismissed,
    ...
    public QuickTemplateEditorBinder.Draft snapshotDraft() {
