...
public final class CallerTrace {
    private CallerTrace() {
    }

    public static String findRelevantCaller(List<StackTraceElement> frames, String targetPackage) {
    ...
    public static String capture(String targetPackage) {
