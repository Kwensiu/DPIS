...
public final class AppWorkspaceScrollStateStore {
    ...
    public AppWorkspacePresentation.ScrollPosition positionFor(AppListPage page) {
    ...
    public void update(AppListPage page, int index, int scrollOffset) {
        int offset = pageOffset(page);
