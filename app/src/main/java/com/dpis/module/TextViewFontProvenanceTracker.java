...
final class TextViewFontProvenanceTracker {
    enum Source {
        RESOURCE_FONT_SCALE,
        TEXTVIEW_SP_REWRITE,
    ...
    static void recordResourcesHandled(Object textView, float currentPx, float factor) {
    ...
    static void recordApplied(Object textView,
                              float basePx,
                              float appliedPx,
                              float factor,
                              Source source,
    ...
    static boolean hasStrongerProvenanceForCurrentPxFallback(Object textView, float factor) {
    ...
    static Entry snapshotForTest(Object textView) {
        Entry entry = getEntry(textView);
        if (entry == null) {
            return null;
        }
