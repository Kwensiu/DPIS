...
public final class ReleaseNotesController {
    ...
    public ReleaseNotesController(ReleaseNotesCacheStore cacheStore,
            Executor executor,
    ...
    public void load(String versionName, boolean hasEmbeddedReleaseNotes, Listener listener) {
        if (listener == null) {
            return;
        }
