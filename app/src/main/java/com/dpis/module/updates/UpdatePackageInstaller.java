...
public final class UpdatePackageInstaller {
    ...
    public static File prepareTargetFile(Context context, String versionName) {
    ...
    public static void persistDownloadState(Context context, long downloadId, File targetFile) {
    ...
    public static void persistDownloadedFile(Context context, File targetFile) {
        persistDownloadState(context, -1L, targetFile);
    }

    public static DownloadState readDownloadState(Context context) {
    ...
    public static void clearUpdateCache(Context context) {
    ...
    public static void clearStaleUpdateCache(Context context, long maxAgeMs) {
        if (maxAgeMs <= 0L) {
    ...
    public static Uri getInstallUri(Context context, File apkFile) {
