...
public final class UpdateAvailableDialog {
    ...
    public static DialogHandle create(Activity activity, CharSequence title, CharSequence message) {
    ...
    public static final class DialogHandle {
        ...
        public final ConstraintLayout releaseNotesHost;
        public final View releaseNotesCard;
        public final View releaseNotesContainer;
        public final MaterialTextView releaseNotesText;
