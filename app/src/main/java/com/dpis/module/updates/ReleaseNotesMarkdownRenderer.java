...
public final class ReleaseNotesMarkdownRenderer {
    ...
    public static CharSequence render(Context context, String markdown, Locale locale) {
    ...
    public static void setRendererForTesting(Renderer testRenderer) {
