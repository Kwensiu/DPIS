...
fun resolveWorkspaceNavigationLayout(
    maxWidth: Dp,
    maxHeight: Dp,
    isCompactUi: Boolean
    ...
    maxWidth < WorkspaceDrawerMinWindowWidth -> WorkspaceNavigationLayout.NAVIGATION_RAIL
    else -> WorkspaceNavigationLayout.NAVIGATION_DRAWER
}
...
fun WorkspaceShell(
    ...
    BoxWithConstraints(modifier = modifier.fillMaxSize()) {
        ...
        when (resolveWorkspaceNavigationLayout(maxWidth, maxHeight, isCompactUi)) {
            WorkspaceNavigationLayout.COMPACT_RADIAL -> CompactWearWorkspaceNavigation(
            ...
            WorkspaceNavigationLayout.BOTTOM_BAR -> Scaffold(
                bottomBar = {
            ...
            WorkspaceNavigationLayout.NAVIGATION_DRAWER -> PermanentNavigationDrawer(
                drawerContent = {
 ...
 */
@Composable
private fun legacyWorkspaceInsetsFor(destination: WorkspaceDestination): PaddingValues {
    ...
    return when (destination) {
        ...
        WorkspaceDestination.TEMPLATE -> PaddingValues(
            end = endPadding,
        ...
        WorkspaceDestination.SETTINGS -> PaddingValues(end = endPadding)
    }
}
