...
public final class TouchFeedbackBinder {
    ...
    public static void bindPressScaleAndHaptic(View view) {
    ...
    public static void bindPressHaptic(View view) {
        if (view == null) {
            return;
        }
    ...
    public static void bindPressScaleAndHaptic(View view, float pressedScale, long animationDurationMs) {
        if (view == null) {
            return;
        }
        view.setHapticFeedbackEnabled(true);
