...
public final class FormInputFocusBinder {
    private FormInputFocusBinder() {
    }

    public static void bindDismissOnOutsideTouch(
            View touchRoot,
    ...
    public static void clearFocusAndHideIme(
            View fallbackFocusView,
            View... inputs
    ) {
        if (inputs != null) {
    ...
    public static boolean hasFocusedInput(View... inputs) {
        if (inputs == null) {
            return false;
        }
        for (View input : inputs) {
    ...
    public static boolean isInsideAny(
            int rawX,
            int rawY,
            View... inputs
    ) {
