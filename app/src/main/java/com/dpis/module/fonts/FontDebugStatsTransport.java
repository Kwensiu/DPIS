...
public final class FontDebugStatsTransport {
    ...
    public static void sendUpdate(Context context, Bundle extras) {
        ...
        try {
            ...
            intent.setComponent(new ComponentName(BuildConfig.APPLICATION_ID,
                    MODULE_CLASS_PACKAGE + ".fonts.FontDebugStatsReceiver"));
        ...
        try {
            ...
            intent.setComponent(new ComponentName(BuildConfig.APPLICATION_ID,
                    MODULE_CLASS_PACKAGE + ".fonts.FontDebugStatsIngestService"));
            intent.putExtras(extras);
        ...
        try {
            Intent intent = new Intent();
            intent.setComponent(new ComponentName(BuildConfig.APPLICATION_ID,
                    MODULE_CLASS_PACKAGE + ".fonts.FontDebugStatsIngestActivity"));
