...
final class SystemFontScaleToolBinder {
    ...
    private final ToolsWorkspaceBinder.Host host;
    ...
    SystemFontScaleToolBinder(Activity activity, View workspaceView, ToolsWorkspaceBinder.Host host) {
        this(activity, workspaceView, host, new SystemFontScaleSettingsGateway());
    }

    SystemFontScaleToolBinder(Activity activity,
                              View workspaceView,
                              ToolsWorkspaceBinder.Host host,
