...
final class AppListFilterStateStore {
    ...
    AppListFilterStateStore(Context context) {
        this(context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE));
    }

    AppListFilterStateStore(SharedPreferences preferences) {
        this.preferences = preferences;
    }

    AppListFilterState load() {
    ...
    boolean save(AppListFilterState state) {
