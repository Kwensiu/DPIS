...
final class HyperOsFlutterFontHookInstaller {
    ...
    static boolean isFlutterViewClassNameForTest(String className) {
    ...
    static boolean isFlutterLibraryNameForTest(String name) {
    ...
    static long parseFlutterBaseForTest(String status) {
    ...
    static long findMappedLibraryBaseForTest(String libraryName) {
    ...
    static long parseMapsStartAddressForTest(String line) {
