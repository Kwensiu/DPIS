...
final class GitHubReleaseNotesFetcher {
    private GitHubReleaseNotesFetcher() {
    }

    static String fetchLatest(int connectTimeoutMs, int readTimeoutMs) throws IOException {
    ...
    static String fetchByVersionName(String versionName, int connectTimeoutMs, int readTimeoutMs)
            throws IOException {
