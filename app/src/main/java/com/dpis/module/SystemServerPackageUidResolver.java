...
final class SystemServerPackageUidResolver {
    ...
    static int userIdFromUid(int uid) {
        if (uid <= 0) {
            return 0;
        }
        try {
