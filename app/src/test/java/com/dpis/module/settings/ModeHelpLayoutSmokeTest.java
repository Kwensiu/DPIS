...
public class ModeHelpLayoutSmokeTest {
    ...
    public void helpAndGuidePreserveNavigationAndAllGuideContentInCompose() throws IOException {
        ...
        String activityContent = read("src/main/java/com/dpis/module/about/presentation/SupportActivityContent.kt");
        String compose = read("src/main/java/com/dpis/module/about/presentation/SupportPages.kt");
        String cards = read("src/main/java/com/dpis/module/about/presentation/SupportCards.kt");
        ...
        assertTrue(compose.contains("rememberConfirmAction"));
