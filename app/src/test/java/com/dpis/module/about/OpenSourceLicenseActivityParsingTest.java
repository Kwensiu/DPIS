...
public class OpenSourceLicenseActivityParsingTest {
    ...
    public void licenseComposePageUsesLazyListAndPreview() throws IOException {
        String content = read(
                "src/main/java/com/dpis/module/about/presentation/OpenSourceLicenseContent.kt");
        ...
        assertTrue(content.contains("rememberConfirmAction"));
    ...
    public void licenseDetailDialogUsesMaterialLargeWidth() throws IOException {
        ...
        String dialog = read("src/main/java/com/dpis/module/about/presentation/LicenseDetailDialog.kt");
