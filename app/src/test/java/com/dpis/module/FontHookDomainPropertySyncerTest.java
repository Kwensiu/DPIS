...
public class FontHookDomainPropertySyncerTest {
    ...
    public void publishWritesRuntimeAndPersistentMask() {
        assertEquals("setprop 'debug.dpis.hookdomains.8eeb79b0' '25'; "
                        + "setprop 'persist.debug.dpis.hookdomains.8eeb79b0' '25'",
    ...
    public void emptyCustomPathPublishesDistinctNonAutomaticValue() {
        assertEquals("setprop 'debug.dpis.hookdomains.8eeb79b0' '1'; "
                        + "setprop 'persist.debug.dpis.hookdomains.8eeb79b0' '1'",
                FontHookDomainPropertySyncer.buildPublishCommandForTest(
                        "org.telegram.messenger",
                        Set.of()));
    }
