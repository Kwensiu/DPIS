...
class StringResourceParityTest {
    ...
    fun localeSwitchUsesWrappedBaseContextAndExplicitRecreate() {
        ...
        main.assertContainsAll("extends LocalizedActivity")
        ...
        license.assertContainsAll(": LocalizedActivity()")
        fontLibrary.assertContainsAll(": LocalizedActivity()")
        fontDetail.assertContainsAll(": LocalizedActivity()")
