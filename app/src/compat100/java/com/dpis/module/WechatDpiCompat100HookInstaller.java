...
final class WechatDpiCompat100HookInstaller {
    ...
    private WechatDpiCompat100HookInstaller() {
    }
    ...
    private static boolean installRoute(
        ...
        if (result.methods.isEmpty()) {
            DpisLog.i("compat100 WeChat DPI hook skipped: locator="
    ...
    private static void applyWechatDpi(DisplayMetrics metrics, String methodName) {
        ...
        if (WechatDpiRuntime.apply(metrics, dpi)
            ...
            DpisLog.i("compat100 WeChat DPI applied: method=" + methodName
                    + ", targetDpi=" + dpi
