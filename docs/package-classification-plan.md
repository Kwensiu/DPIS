...
| `runtime.presentation` | `ModuleRuntimeReloadNoticeCoordinator` | Activity-bound one-time reload notice. Advisor/state stay in `runtime`; the coordinator only owns the host lifecycle. |
