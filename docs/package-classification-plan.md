...
| `ui` | `ComposeOverlay` | Activity-owned composition host for remaining Java `show()` dialogs and sheets. Visible chrome comes from `ModalDialog` or `ModalSheet`; do not restore View dialog helpers. |
