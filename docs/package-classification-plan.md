...
| `fonts` | `HyperOsNativeProxyRefreshCoordinator` | Dormant native-proxy refresh helper moved with HyperOS font tooling. The existing warning remains: do not wire it into startup/package replacement without revisiting native file side effects. |
