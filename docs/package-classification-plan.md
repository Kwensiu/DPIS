...
| `quickconfig` | `QuickConfigTileService` | QS tile component moved with quick-config ownership. The Activity stays root-owned until its config-store and diagnostic entry seams are isolated. |
